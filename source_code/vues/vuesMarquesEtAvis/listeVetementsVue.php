...
-->
    <div class="laisser_avis">
        ...
        <form action="index.php?action=publiAvisVetement&amp;marqueM=<?= $data2['nom_marque'] ?> " class="form_laisser_avis" method="post">
        ...
        <li class="marque_et_avis">
            ...
            if ($data["0dechet"] == 1){ ?>
                    ...
                    <div class="actions_une_marque">
                        <?php
                    if ($data["note_avis"] != ""){ ?>
                        <a href="index.php?action=pageAvisVetements&amp;marqueM=<?= $data['nom_marque'] ?>" class="display_avis">Afficher les avis</a>
